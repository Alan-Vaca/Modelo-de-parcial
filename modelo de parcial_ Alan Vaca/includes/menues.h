...
void MenuPrincipal(){                                                           //FUNCION DEL MENU PRINCIPAL
    ...
    case 13: //ENTER
        ...
        break;
        case 3:
            menuParcial();                                                                 ///APARTADO "REPORTES"
        break;
        case 4:
            menuConfiguraciones();                                                                 ///APARTADO "CONFIGURACION"
        break;
        ...
        recuadro(30,20,38,2);
        gotoxy(31,21); cout << "           MODELO PARCIAL";
        recuadro(30,23,38,2);
...
system("cls");
    ...
    recuadro(26,10,46,25);
    SetConsoleTextAttribute(hConsole, 7);
    gotoxy(31,11); cout << "          PARCIAL RESPUESTAS";
    gotoxy(27,12); cout << "---------------------------------------------";
    gotoxy(27,32); cout << "---------------------------------------------";
    while(true){
    switch(opc){
    ...
    case 13: //ENTER
        ...
        switch(pos){
        case 1:                                                                 ///APARTADO "REPORTES"
        ShowConsoleCursor(false);
        SetConsoleTextAttribute(hConsole, 6);
        recuadro(30,16,38,2);
        gotoxy(31,17); cout << "             ACTIVIDAD 1";
        SetConsoleTextAttribute(hConsole, 7);
        recuadro(30,19,38,2);
        gotoxy(31,20); cout << "             ACTIVIDAD 2";
        recuadro(30,22,38,2);
        gotoxy(31,23); cout << "            INHABILITADO";
        recuadro(30,28,38,2);
        gotoxy(31,29);cout << "            MENU PRINCIPAL";
        break;
        case 2:                                                                 ///APARTADO "REPORTES"
        ShowConsoleCursor(false);
        recuadro(30,16,38,2);
        gotoxy(31,17); cout << "             ACTIVIDAD 1";
        SetConsoleTextAttribute(hConsole, 6);
...
system("cls");
    ...
    recuadro(26,10,46,25);
    SetConsoleTextAttribute(hConsole, 7);
    gotoxy(31,11); cout << "            MENU CONFIGURACION";
    gotoxy(27,12); cout << "---------------------------------------------";
    gotoxy(27,32); cout << "---------------------------------------------";
    while(true){
    switch(opc){
    ...
    case 13: //ENTER
        ...
        SetConsoleTextAttribute(hConsole, 6);
        recuadro(30,16,38,2);
        gotoxy(31,17); cout << "      REALIZAR COPIA DE SEGURIDAD";
        SetConsoleTextAttribute(hConsole, 7);
        recuadro(30,20,38,2);
        gotoxy(31,21); cout << "      RESTARUAR COPIA DE SEGURIDAD";
        recuadro(30,28,38,2);
        gotoxy(31,29);cout << "            MENU PRINCIPAL";
        break;
        case 2:                                                                 ///APARTADO "REPORTES"
